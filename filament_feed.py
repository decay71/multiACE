    ...
    def _do_feed(self, ch, action=None, stage=None, auto_mode=None):
        ...
        try:
            ...
            # load
                ...
                try:
                    ...
                    if self.runout_sensor[ch].get_status(0)['filament_detected'] == False:
                        ...
                        # [mUlt1ACE] Rewritten: Original sent a fixed 100mm feed at speed 20.
                        ...
                        if self.ace is not None:
                            self.ace._disable_feed_assist()    # [mUlt1ACE] Prevents conflict with previous toolhead's feed_assist
                            ...
                            for load_attempt in range(load_retries + 1):
                                ...
                                self.reactor.pause(self.reactor.monotonic() + 4.0)  # [mUlt1ACE] Wait for ACE to start motors
            ...
            # unload
                ...
                # [mUlt1ACE] Added: Disable feed_assist before unloading to prevent
                ...
                if stage == FEED_UNLOAD_STAGE_PREPARE:
                    ...
                    try:
                        ...
                        # [mUlt1ACE] Rewritten: Original did a single retract_fil() with no verification.
                    ...
                    try:
                        ...
                        # [mUlt1ACE] Rewritten: Same retry logic as the first unload path.
