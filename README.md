...
- Not compatible with 1.6.0 firmware, its flow calibrator expects a new nozzle attribute, and in ace mode this leads to
a Klipper shutdown, will be ported with the next version
